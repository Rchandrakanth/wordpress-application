 ...
 */
function homedecorstyle_sanitize_checkbox( $checked ) {
	// Boolean check.
...
function homedecorstyle_switch_sanitization( $input ) {
    if ( true === $input ) {
        return 1;
    } else {
        return 0;
...
function homedecorstyle_sanitize_choices( $input, $setting ) {
    global $wp_customize; 
...
function homedecorstyle_sanitize_float( $input ) {
 ...
 */
function homedecorstyle_sanitize_hex_color( $hex_color, $setting ) {
 ...
 */
function homedecorstyle_sanitize_html( $html ) {
 ...
 */
function homedecorstyle_sanitize_image( $image, $setting ) {
 ...
 */
function homedecorstyle_sanitize_nohtml( $nohtml ) {
 ...
 */
function homedecorstyle_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function homedecorstyle_sanitize_range_value( $number, $setting ) {
 ...
 */
function homedecorstyle_sanitize_select( $input, $setting ) {
 ...
 */
function homedecorstyle_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


/* Sanitization Text*/
function homedecorstyle_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function homedecorstyle_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}
